...
#                 C[i][j] = HARD_PENALTY
#
#         # RULE 3: Different modules cannot be parallel (except Personal tutorials)
#         if module_i != module_j:
...
# Bookmark:
# fix the timetable issue where incorrect assignment of groups with teachers is taking place
# introduce clashes between different modules of different groups
# analyse timetable
